...
# Features
- ### BEST CHAT SYSTEM
  @ the bot and it will reply to you. Anyone can reply to the bot's message to continue the conversation from that point. Build conversations with reply chains!
...
| **MAX_IMAGES** | The maximum number of image attachments to accept in a single message. Only applicable when using a vision model. (Default: 5) |
